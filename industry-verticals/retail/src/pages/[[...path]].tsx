...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  // Skip paths with static file extensions - let Next.js serve from public/ folder
  if (
    path &&
    /\.(html|htm|css|js|json|xml|txt|pdf|zip|ico|png|jpg|jpeg|gif|svg|webp|woff|woff2|ttf|eot)$/i.test(
      path
    )
  ) {
